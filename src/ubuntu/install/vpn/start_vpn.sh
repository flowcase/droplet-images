...
function get_set_creds() {
  ...
  echo ${USER} > /home/flowcase-user/vpn_credentials
  echo ${PASS} >> /home/flowcase-user/vpn_credentials
  chown flowcase-user:flowcase-user /home/flowcase-user/vpn_credentials
  cp ${VPN_CONFIG} /home/flowcase-user/vpn.ovpn
  chown flowcase-user:flowcase-user /home/flowcase-user/vpn.ovpn
  sed -i "s#auth-user-pass#auth-user-pass /home/flowcase-user/vpn_credentials#g" /home/flowcase-user/vpn.ovpn
  VPN_CONFIG=/home/flowcase-user/vpn.ovpn
}
